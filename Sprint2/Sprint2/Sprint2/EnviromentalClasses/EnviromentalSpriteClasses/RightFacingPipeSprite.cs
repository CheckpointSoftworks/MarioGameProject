...
namespace Sprint2
{
    public class RightFacingPipeSprite : ISprite
    {
        private Texture2D pipeSpriteSheet;
        private Vector2 location;
        private AnimatedSprite pipeSprite;
        private Rectangle collisionRectangle;
        public RightFacingPipeSprite(Vector2 location)
        {
            pipeSpriteSheet = MiscGameObjectTextureStorage.CreateRightFacingPipeSprite();
