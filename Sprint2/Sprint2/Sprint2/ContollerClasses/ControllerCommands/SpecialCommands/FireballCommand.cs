    ...
    public class FireballCommand:ICommand
    {
        ...
        public void Execute()
        {
            ...
            if (((Mario)game.mario).CanFire && game.fireBallCount>0)
            {
                ...
                game.levelStore.projectileList.Add(new Fireball((int)marioLoc.X + UtilityClass.fireballSpawnXOffset, (int)marioLoc.Y + UtilityClass.fireballSpawnYOffset, facingRight));
                game.fireBallCount--;
